...
import noAsyncWithoutAwait from "eslint-plugin-no-async-without-await";
import noNull from "eslint-plugin-no-null";
import simpleImportSort from "eslint-plugin-simple-import-sort";
import reactHooksStaticDeps from "eslint-plugin-react-hooks-static-deps";
import eslintMultitabTt from "eslint-plugin-eslint-multitab-tt";
...
export default defineConfig([globalIgnores([
    ...
    extends: compat.extends("teact-app", "airbnb", "airbnb-typescript"),
    ...
    plugins: {
        ...
        "eslint-multitab-tt": eslintMultitabTt,
    },
    ...
    rules: {
        ...
        "simple-import-sort/imports": ["error", {
            groups: [["^\\u0000"], [
                ...
                "^\\.(?!/?$)",
                "^\\./?$",
            ], [".+(/hooks/)(.*|$)"], ["/[A-Z](([a-z]+[A-Z]?)*)"], ["^.+\\.s?css$"], ["^(\\.+/)+(assets)(/.*|$)"]],
        }],
    },
}]);